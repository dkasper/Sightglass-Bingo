...
#import "PF_ASIHTTPRequestDelegate.h"
#import "PF_ASIProgressDelegate.h"

@interface PF_ASINetworkQueue : NSOperationQueue <PF_ASIProgressDelegate, PF_ASIHTTPRequestDelegate, NSCopying> {
